...
public class ChildrenServiceAdapter extends RecyclerView.Adapter<ChildrenServiceAdapter.ViewHolder> {
    private Context context;
    private List<ChildrenService> serviceList;
    private List<ChildrenService> selectedServices = new ArrayList<>();
    ...
    public ChildrenServiceAdapter(Context context, List<ChildrenService> serviceList, TextView totalAmountTextView) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ChildrenService service = serviceList.get(position);
    ...
    public List<ChildrenService> getSelectedServices() {
