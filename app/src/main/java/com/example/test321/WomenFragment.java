...
public class WomenFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        servicesContainer = view.findViewById(R.id.services_container_women);
        editButton = view.findViewById(R.id.button_edit_women);
        saveButton = view.findViewById(R.id.button_save_women);
        ...
        Toolbar toolbar = view.findViewById(R.id.women_toolbar);
...
// Handle back arrow click
    ...
    private void loadServicesFromFirebase() {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("services&prices/Women");
