...
public class ChildrenFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        servicesContainer = view.findViewById(R.id.services_container_children);
        editButton = view.findViewById(R.id.button_edit_children);
        saveButton = view.findViewById(R.id.button_save_children);
        ...
        Toolbar toolbar = view.findViewById(R.id.children_toolbar);
...
// Handle back arrow click
    ...
    private void loadServicesFromFirebase() {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("services&prices/Children");
